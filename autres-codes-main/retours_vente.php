...
<div class="modal-dialog">
	<div class="modal-content btn-light">
		<div class="modal-header">
			<h4 class="modal-title">Annuler Achat | Retours du produit</h4><button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times</button>
		</div> <div class="modal-body">
<!-- actual form -->
<form role="form" action="new_retours_vente.php" method="post">
	<div class="form-group">
		<label>Choisir la date du retours</label>
		<input class="form-control" value="" name="description_date" type="DATE">
	</div>
	<!------------------AUTO LISTE SHOP------------------>
	<div class="form-group">
		<label>Point de vente</label>
		<select class="form-control btn-brown text-light" name="point_de_vente">
...
##########################################################
$client_name = "";
		$query_client_name = $bdd->prepare("SELECT * FROM stock_prep WHERE description_date LIKE '%Abandon%' AND user_stock_prep = ?");
...
<br>
<br>
<form role="form" action="simple_retours_vente.php" method="POST">
<div class="text-center">
		...
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="<?php echo 'no'.$donnees['id_x']; ?>" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<!-- actual form -->
					<form role="form" action="insert_vente_retours_prep.php" method="post">
						<div class="form-group">
...
# QUERY GET DISTINCT USER
		$query_user = $bdd->prepare("SELECT user_stock_prep,nom_du_client,numero_stock_prep,description_date FROM stock_prep WHERE description_date LIKE '%Abandon%' GROUP BY user_stock_prep");
...
?>
	...
	<div class="text-center">
    <h2 class="top20_style">ABANDON</h2>
    </div>
	<div class="container">
...
?>
		...
		<td><a class="center" href="delete_retours_vente_prep.php?id_stock_prep=<?php echo $donnees['id_stock_prep']; ?>" onclick="confirmationDelete('Do you want to DELETE this line?');return false; post ;"><img src="img/deleteicon.png" height="30" width="30" background alt="Edit" /></a></td>
		<?php
		}//Close else 
		?>
<!-------FORM DE MODIFIER-------->
		...
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="<?php echo "no".$donnees['id_stock_prep']; ?>" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
					<!-- actual form -->
					<form role="form" action="modifier_retours_vente.php" method="post">
						<div class="form-group">
						<label>Quantite (Ex: Atsasany : 0.5 ; Fefany : 0.25)</label>
...
?>
<a class="center" href="anuler_retours_vente.php" onclick="confirmationDelete('Anuler cette action?');return false; post ;"><button type="button" class="btn btn-danger">Anuler</button></a>
<a class="center" href="valider_retours_vente.php" onclick="confirmationDelete('Valider le stock?');return false; post ;"><button type="button" class="btn btn-success">Valider</button></a>
<?php
}// close ELSE
 ?>
<br>
