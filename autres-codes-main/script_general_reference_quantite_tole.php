...
<html>
<head>
    <title>Stock Ambaiboho Tole</title>
    <!---add bootstrap css--->
...
<br>
<br>
<h4 id="ancre1" class="text-center">QUANTITE ACTUELLE AMBAIBOHO TOLE</h4>
<?php
//Connect to BD
include('connect.php');

   //Query to liste searched product
    $nom_client_fournisseur = 'Ambaibo_Tole';
   $query_stock_inventaire = "SELECT produit.id_x as id_x, nom_x, prix_de_vente, (SUM(qt)) as sm, reference_x, note_x FROM mvt INNER JOIN  produit ON mvt.id_x = produit.id_x WHERE nom_client_fournisseur ='Ambaibo_Tole' GROUP BY id_x ORDER BY sm;";
