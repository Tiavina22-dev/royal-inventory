...
$nom_client_fournisseur ='Ambato_Tantely';
   ...
   $query_stock_inventaire = "SELECT produit.id_x as id_x, nom_x, prix_de_vente, (SUM(qt)) as sm, reference_x, note_x FROM mvt INNER JOIN produit ON mvt.id_x = produit.id_x WHERE nom_client_fournisseur ='Ambato_Tantely' GROUP BY id_x ORDER BY sm;";
