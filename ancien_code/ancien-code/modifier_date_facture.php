...
*/
	...
	//Query to Change description date of mvt and fournisseur
	$query_c = "UPDATE mvt
            SET description_date = ?, nom_client_fournisseur = ?, Date_du_Journal_mvt = ?, user_mvt = ?
            WHERE numero_commande_stock = ? AND type_de_mvt = 'facture'";

	$q = $bdd->prepare($query_c);

	$q->execute(array($description_date,$nom_client_fournisseur, $date1_mysql, $username, $no_activite,));	
