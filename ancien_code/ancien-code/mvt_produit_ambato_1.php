...
<!--------------------------------------->
<form role="form" action="simple_search_mvt_ambato_1.php" method="POST">
...
<br>
<input type="search" class="light-table-filter" name="key_word" placeholder="Name/Ref/id_x">
<?php
}
?>
...
//QUERY TO GET LISTE PRIX DE VENTE
   $query_prix = "SELECT * FROM mvt WHERE id_x = ? AND prix_unitaire != 0 AND prix_unitaire IS NOT NULL";
    ...
    $pu_list='';
    $pu_list="<b># ".($donnees['pu_ambato_tantely']+0)." : PU Ambato</b>"."<br>";
    $k = 4;
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="<?php echo ("no".$j); ?>" class="modal fade">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <h4 class="modal-title"><b><?php echo $donnees['nom_x']; ?><br>PU Tantely : <?php echo $donnees['pu_ambato_tantely']; ?></b></h4>
