...
while ($donnees = $query_get_all_commande -> fetch())
{
	...
	$history = $history."# ".$no." # ".$donnees['nom_x']."|qt:".$qt."|PU:".$prix_unitaire."|MT:".$donnees['sous_total']." #"."\r";
...
$history = $history."\r"."######AUTOMATIQUE GRAND TL:".$somme." Ar#######"."\r"."-------------------------------------"."\r"."--------VERSEMEMT:".$versement." Ar-------"."\r"."-------------------------------------";
