...
<body style="background: #6c757d">
 ...
 <br>
 <br>
 <h2 class="text-center text-warning">MOUVEMENT DES PRODUITS</h2>
</body>
<!--------------------------------------->
<form role="form" action="simple_search_mvt.php" method="POST">
<div class="center">
<?php  
if (isset($_COOKIE['key_word'])) 
{
    ...
    if ($point_de_vente == "Ambatomainty") {$S2 = "selected";}
    if ($point_de_vente == "Sahamamy") {$S3 = "selected";}
...
<br>
    <div>
        ...
        <option class="btn-warning" value="Ambatomainty" <?php echo $S2;?>>AMBATOMAINTY</option>
        <option class="btn-warning" value="Sahamamy" <?php echo $S2;?>>SAHAMAMY</option>
        </select>
    </div>
<br>
...
<br>
    <div>
        ...
        <option class="btn-warning" value="Ambatomainty">AMBATOMAINTY</option>
        <option class="btn-warning" value="Sahamamy">SAHAMAMY</option>
        </select>
    </div>
    <!-------------------------------------------------
    <select oninput="Check_shop($(this));" id="shop_id" class="select-btn" name="point_de_vente">
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="<?php echo ("no".$j); ?>" class="modal fade">
            <div class="modal-dialog modal-lg">
                <div class="modal-content btn-brown">
                    ...
                    <h4 class="modal-title"><span style='font-weight: bold'><?php echo $donnees['nom_x']; ?><br>PF:<?php echo $donnees['prix_fournisseur']; ?> | PU General:<?php echo $donnees['prix_de_vente']; ?> | PU Afa:<?php echo $donnees['pu_aparafa']; ?> | PU Tantely:<?php echo $donnees['pu_ambato_tantely']; ?></span></h4>
                    ...
                    <form role="form">
                        ...
                        { 
                            ...
                            <li class="list-group-item">
                          	<span class="text-danger" ><?php echo $donnees1['nom_client_fournisseur']; ?> | INVENTAIRE GENERAL | <?php echo $donnees1['Date_du_Journal_mvt']; ?> | <?php echo $donnees1['user_mvt']; ?> | <span style='font-weight: bold' class="text-dark"><?php echo number_format($donnees1['prix_unitaire'],0, "", " "); ?></span></span> - <span class="text-warning" ><?php echo number_format(($donnees1['prix_client']+0),0, "", " "); ?></span><span class="text-success float-right"><?php echo $donnees1['note']; ?></span><span class="w3-badge w3-right w3-margin-right <?php echo $badge_color; ?>"><?php echo $qt_GI; ?></span>
                          	<br> | Quantité : <?php echo $donnees1['qt']; ?>
                          	<br> | Différence : <?php echo $donnees1['prix_aparafa']; ?>
                          	<br> | Observation : <?php 
                          	if ($donnees1['prix_aparafa'] == 0) {
                          		echo "<span class ='text-success'>OK</span>";
                          	} 
                          	if ($donnees1['prix_aparafa'] > 0) {
                          		echo "<span class ='text-warning'>MIHOATRA</span>";
                          	}
                          	if ($donnees1['prix_aparafa'] < 0) {
                          		echo "<span class ='text-danger'>BANGA</span>";
                          	}
                          	?>
                          </li>
                            	<?php
                            ...
                            } else //IF OFF
                            {
                            	?>
                            	<li class="list-group-item">
                          	<span class="text-danger" ><?php echo $donnees1['nom_client_fournisseur']; ?> | INVENTAIRE GENERAL | <?php echo $donnees1['Date_du_Journal_mvt']; ?> | <?php echo $donnees1['user_mvt']; ?> | <span style='font-weight: bold' class="text-dark"><?php echo number_format($donnees1['prix_unitaire'],0, "", " "); ?></span></span> - <span class="text-warning" ><?php echo number_format(($donnees1['prix_client']+0),0, "", " "); ?></span><span class="w3-badge w3-right w3-margin-right <?php echo $badge_color; ?>"><?php echo $aff_qt_GI; ?></span>
                          	<br> | Quantité : <?php echo $donnees1['qt']; ?>
                          	<br> | Différence : <?php echo $donnees1['prix_aparafa']; ?>
                          	<br> | Observation : <?php 
                          	if ($donnees1['prix_aparafa'] == 0) {
                            ...
                            ?>
                          <li class="list-group-item <?php echo $text_color; ?>"><?php echo $donnees1['nom_client_fournisseur']; ?> | <?php echo $donnees1['description_date']; ?> | <?php
                          if ($donnees1['id_x'] == 134655) {
                            echo $donnees1['note'].' | ';
                          }
                          echo $donnees1['user_mvt']; ?> | <span style='font-weight: bold' class="text-dark"><?php echo number_format($donnees1['prix_unitaire'],0, "", " "); ?>  - <span class="text-warning" ><?php echo number_format(($donnees1['prix_client']+0),0, "", " "); ?> | -----</span><span class="text-success"><?php echo $donnees1['note']; ?></span><span class="w3-badge w3-right w3-margin-right <?php echo $badge_color; ?>"><?php echo $donnees1['qt']; ?></span></li>
                        <?php
                        }
                        }
                        $qs->closeCursor();
                        ...
                        <li class="list-group-item"><span style='font-weight: bold' class="text-danger">TOTAL STOCK<span class="w3-badge w3-right w3-margin-right"><?php echo number_format($total_stock,2); ?></span></span></li>
                        </ul>
                        </div>
                        <div class="form-group">
                   ...
                   <!----------       <li class="list-group-item"><?php echo $donnees2['nom_client_fournisseur']; ?> | <a href="vente_recap_details.php?nom_client_fournisseur=<?php echo $point_de_vente; ?>&description_date=<?php echo $donnees2['description_date']; ?>"><b><span class="text-orange-1"><?php echo $donnees2['description_date']; ?></span></b></a> | <?php
                          if ($donnees2['id_x'] == 134655) {
                            echo $donnees2['note'].' | ';
                          }
                          echo $donnees2['user_mvt']; ?> | <span style='font-weight: bold' class="text-danger"><?php echo $donnees2['prix_unitaire']; ?> - <span class="text-info" ><?php echo number_format(($donnees2['prix_client']+0),0, "", " ") ; ?></span></span><span class="text-dark" > <?php echo  $donnees2['note'] ; ?></span><span class="w3-badge w3-right w3-margin-right <?php echo $badge_color; ?>"><?php echo ABS($donnees2['qt']); ?></span></li> ---------->
                        ...
                        <ul class="list-group">
                            ...
                            $qpv3->closeCursor();
                            ?>
                            <li class="list-group-item"><span style='font-weight: bold' class="text-danger">RESTE TOTAL<span class="w3-badge w3-right w3-margin-right w3-deep-purple"><?php echo number_format(($total_stock+$total_vente),2); ?></span></span></li>
                        </ul>
                        </div>
                        </div>
                    </form>
