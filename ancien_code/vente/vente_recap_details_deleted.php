...
<a href="vente_recap_deleted.php"><button type="submit" class="btn btn-info">RETOURS</button></a>
</div>
<br>
...
*/
   ...
   $query_stock_inventaire = "SELECT *,nom_x,prix_unitaire,qt,numero_commande_stock,ref_commande_stock from mvt_history NATURAL JOIN produit WHERE nom_client_fournisseur = ? AND description_date = ? AND type_de_mvt = 'vente' ORDER BY id_mvt DESC";
...
<!------------------------------------------------->
		...
		$query_history -> execute(array($donnees['id_mvt']));
		//Number of Line
