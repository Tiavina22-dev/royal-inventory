...
<a href="vente_recap_andrefana.php"><button type="submit" class="btn btn-info">RETOURS</button></a>
</div>
<br>
<br>
<br>
...
*/
   ...
   $query_stock_inventaire = "SELECT *,nom_x,prix_unitaire,qt,numero_commande_stock,ref_commande_stock from mvt_calc NATURAL JOIN produit WHERE nom_client_fournisseur = ? AND description_date = ? AND type_de_mvt = 'vente' ORDER BY id_mvt DESC";
...
//Query to get path/Date/Note
   $query_path_date = 'SELECT * from recap_vente_calc WHERE no_activite = ?';
		...
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit" class="modal fade">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<!-- actual form -->
					<form role="form" action="modifier_path_date_andrefana.php" method="post">
...
<!------------------------------------------------->
        ...
        if ($nom_client_fournisseur=="Amparafa") {
       	?>
       	<td><?php echo $donnees['prix_aparafa']; ?></td>
       	<td><?php echo ($donnees['prix_aparafa']*abs($donnees['qt'])); ?></td>
		...
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="<?php echo "no".$donnees['id_mvt']; ?>" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
					<!-- actual form -->
					<form role="form" action="modifier_mvt_vente_andrefana.php" method="post">
						<div class="form-group">
						...
						<input class="form-control btn-danger" name="prix_aparafa" value="<?php echo $donnees['prix_aparafa']; ?>" type="number" id="<?php echo $textzone_id2; ?>" style="display:none">
						</div>
						<div class="form-group">
