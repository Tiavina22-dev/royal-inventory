...
if (isset($_POST['prix_ambato'])) {
  $prix_ambato = $_POST['prix_ambato'];
}
...
$query_c = "INSERT INTO commande(numero_commande, nom_du_client,description_date, id_x, qt, prix_de_vente,prix_aparafa, state,note_commande,user) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	$q->execute(array($numero_commande, $nom_du_client,$description_date, $id_x, $qt, $prix_de_vente,$prix_ambato, $state,$note_commande,$username));	
