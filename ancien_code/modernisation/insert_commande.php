...
$reponse->closeCursor();
//-------------------------------------------
$query_c = "INSERT INTO commande(numero_commande, nom_du_client,description_date, id_x, qt, prix_de_vente,prix_client, state,note_commande,user) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

	$q = $bdd->prepare($query_c);

	$q->execute(array($numero_commande, $nom_du_client,$description_date, $id_x, $qt, $prix_de_vente,$prix_client, $state,$note_commande,$username));	
