...
if ($username=='STANDARD') {
	# QUERY GET DISTINCT USER
		$query_user = $bdd->prepare('SELECT DISTINCT(user) FROM vente_calc');
...
<form role="form" action="new_client_name_commande_andrefana.php" method="post">
	...
	<div class="form-group">
		<input class="form-control btn" name="point_de_vente" value="Andrefana" type="hidden">
	</div>
	<div class="form-group">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form role="form" action="insert_commande_andrefana.php" method="post">
						...
						<input class="form-control btn-danger" name="prix_aparafa" value="<?php echo $donnees['pu_aparafa']; ?>" type="number" id="<?php echo $textzone_id; ?>" style="display:none" oninput="Montant3Function($(this));">
						</div>
						<?php }else{; ?>
						<div>
...
<div>
	<label><b>VERSEMENT POUR ROYAL SEULEMENT</b></label>
...
<a class="center" href="fusion_andrefana.php" onclick="confirmationDelete('Anuler le commande?');return false; post ;"><button type="button" class="btn btn-primary">Fusionner</button></a>
