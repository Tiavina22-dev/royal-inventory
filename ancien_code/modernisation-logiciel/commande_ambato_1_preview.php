...
<div class="text-center">
<input type="search" class="light-table-filter" name="key_word" placeholder="Name/Code/Search" value="<?php echo $key_word; ?>" <?php echo $blockage; ?>>
...
//GET ALL PRIX number_format($difference_prix,0, "", " ")
    $pu_list='';
    $pu_list="<b># ".number_format(($donnees['pu_ambato_tantely']+0),0, "", " ")." : PU Ambato</b>"."<br>";
...
?>
	...
	<input type="button" class="float-right bg-secondary font-weight-bold text-light" value="Dévérroullier <?php echo ($total_line); ?> Lignes" data-toggle="modal" data-target="#Edit_Mode">
...
<!-------------------------------------->
	...
	?>
	<div class="form-group text-center">
	<a href="valider_waiting_commande_ambato_1.php" class="center" onclick="confirmationDelete('Valider le commande?');return false; post ;"><button class="btn btn-danger">Verroullier (Payment Effectué)</button></a>
	<a href="commande_ambato_1_export.php" class="center"><button class="btn btn-warning">PDF ROYAL</button></a>
	</div>
	<?php
		}
	?>
	 <table class="table-info table">
        <thead>
        <tr>
        	<th class="text-center" colspan="13"><?php echo ($client_name." || ".$description_date." (Activiter No. ".$num_stock.")"); ?></th>
        </tr>
        <tr>
        <th>No.</th>
        <th>CODE</th>
...
?>
		...
		<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#<?php echo "no".$donnees['id_commande']; ?>" <?php echo $state_button; ?>>Modifier</button></td>
		<td><a style="<?php echo $state_suppr; ?>;" class="center" href="delete_commande_ambato_1.php?id_commande=<?php echo $donnees['id_commande']; ?>" onclick="confirmationDelete('Do you want to DELETE this line?');return false; post ;"><img src="img/deleteicon2.png" height="30" width="30" background alt="Edit"/></a></td>
<!-------FORM DE MODIFIER-------->
		<!-- modal form MODIFIER-->
...
?>
		        ...
		        <th>GLOBAL</br><span class="text-secondary">ROYAL</span></br><span class="text-primary">AMBATO</span></th>
		        ...
		        <th class="text-danger"><a href="" data-toggle="modal" data-target="#famerimbola_click"><?php if ($total_waiting != 0) {echo number_format(($total_waiting),0, "", " ");}  ?></a></th>
		        <th colspan="2" class="text-danger"></th>
<!-------FORM FAMERIMBOLA-------->
		...
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="Print_click" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
					<!-- actual form -->
					<form role="form" action="commande_ambato_1_export.php" method="post">
						<div class="form-group">
...
<div class="form-group text-center">
<a class="center" style="<?php echo $state_suppr; ?>;" href="anuler_commande_ambato_1.php" onclick="confirmationDelete('Anuler le commande?');return false; post ;"><button type="button" class="btn btn-danger" <?php echo $state_button; ?>>Anuler</button></a>
