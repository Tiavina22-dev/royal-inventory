...
//Query to liste negatif product
   $query_update = "SELECT * FROM history WHERE type = 'cisco' ORDER BY date_time DESC";
...
<br>
<br>
<h3>COMMAND <img src="img/cisco.jpg" height="40" width="90" background alt="Edit" /> <a class="center" href="#" data-toggle="modal" data-target="#add"><img src="img/eeeee_icon.png" height="30" width="30" background alt="Edit" /></a></h3>
...
<a href="delete_cisco.php?id=<?php echo $donnees['history_id']; ?>" onclick="confirmationDelete('DELETE THIS LINE?');return false; post ;"><button type="button" class="btn btn-warning">DELETE</button></a>
<?php
}
?>
</span>
		...
		<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="<?php echo "ci".$donnees['history_id']; ?>" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<!-- actual form -->
					<form role="form" action="modifier_cisco.php" method="post">
...
<!-------------------------------------->
    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="add" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
          <h4 class="modal-title">ADD CISCO COMMAND</h4>
          <button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times</button>
          </div>
          <div class="modal-body">
          <!-- actual form -->
          <form role="form" action="add_cisco_command.php" method="post">
            <div class="form-group">
	            <label>COMMAND (Color:@danger, @info, @warning, @primary, @secondary,@white, @close)</label>
