...
{ 
?>
<span class="puce4"><?php echo $donnees['date_time'].' : '.$donnees['details'].' - by ' .$donnees['responsable']; ?></span>
<?php
}
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form role="form" action="add_history_update.php" method="post">
            ...
            <input class="form-control text-center" name="history_details" placeholder="Add update details here" type="text">
            </div>
