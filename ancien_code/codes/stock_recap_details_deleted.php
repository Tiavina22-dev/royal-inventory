...
<a href="stock_recap_deleted.php"><button type="submit" class="btn btn-info">RETOURS</button></a>
<br>
...
*/
   ...
   $query_stock_inventaire = "SELECT *,nom_x,prix_unitaire,qt,numero_commande_stock,ref_commande_stock from mvt_history NATURAL JOIN produit WHERE nom_client_fournisseur = ? AND description_date = ? AND type_de_mvt = 'stock'";
