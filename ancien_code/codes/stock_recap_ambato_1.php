...
<body>
 ...
 <div class="container">
  <h2>LISTE INVENTAIRE ET ENVOIE STOCK</h2>
  <ul class="list-group">
 <?php
 include('connect.php');
 //Query to liste FOR GROUPAGE INVENTORY
$query_gp ="SELECT *,description_date,nom_client_fournisseur,numero_commande_stock FROM mvt WHERE type_de_mvt='stock' AND nom_client_fournisseur = 'Ambato_Tantely' GROUP BY description_date,nom_client_fournisseur ORDER BY numero_commande_stock DESC;" ;
...
?>
    ...
    <li class="<?php echo $color;?>" data-target="#<?php echo $donnees['numero_commande_stock']; ?>"><a href="stock_recap_details.php?nom_client_fournisseur=<?php echo $point_de_vente; ?>&description_date=<?php echo $donnees['description_date']; ?>&no_activite=<?php echo $target; ?>"><?php echo $donnees['description_date'].' | '.$point_de_vente.' | by '.$user_stock_prep;?></a></li>
<?php
}
