...
$query_get_all_commande = "SELECT * FROM stock_prep WHERE description_date LIKE '%Abandon%' AND user_stock_prep = ? ;";
...
//-----------DELETE COMMANDE------------
include('anuler_retours_vente.php');
...
header("location: retours_vente.php");
