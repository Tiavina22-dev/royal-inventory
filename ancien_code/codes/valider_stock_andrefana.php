...
$query_get_all_commande = "SELECT * FROM stock_prep_calc WHERE description_date LIKE '%Ajout%' AND user_stock_prep = ? ;";
...
//-----------DELETE COMMANDE------------
$query_c = "DELETE FROM stock_prep_calc WHERE description_date LIKE '%Ajout%' AND user_stock_prep = ? ";
