...
*/
	...
	$query_current_mvt ="SELECT * FROM mvt WHERE numero_commande_stock = ? AND type_de_mvt = 'vente'";
	$query_current_mvt = $bdd->prepare($query_current_mvt);
	$query_current_mvt -> execute(array($numero_commande));
	...
	//-----------DELETE COMMANDE------------
//-------------------------------------------
	$query_c = "DELETE FROM mvt WHERE numero_commande_stock = ? AND type_de_mvt = 'vente'";
