...
<body style="background: #EAE8E8">
 ...
 <?php include("footer.php"); ?>
	...
	<br>
 <div class="container">
  <h2>STOCK SUPPRIME</h2>
  <ul class="list-group">
 <?php
 include('connect.php');
 //Query to liste FOR GROUPAGE INVENTORY
$query_gp ="SELECT *,description_date,nom_client_fournisseur,numero_commande_stock FROM mvt_history WHERE type_de_mvt='stock' GROUP BY description_date,nom_client_fournisseur ORDER BY numero_commande_stock DESC;" ;
...
?>
    ...
    <li class="<?php echo $color;?>" data-target="#<?php echo $donnees['numero_commande_stock']; ?>"><a target="_blank" rel="noopener noreferrer" href="stock_recap_details_deleted.php?nom_client_fournisseur=<?php echo $point_de_vente; ?>&description_date=<?php echo $donnees['description_date']; ?>&no_activite=<?php echo $target; ?>"><?php echo $donnees['description_date'].' | '.$point_de_vente.' | by '.$user_stock_prep.' on '.$date_time.$noti;?></a><span class="w3-badge w3-margin-right w3-red"><?php echo $GI; ?></span></li>
<?php
}
