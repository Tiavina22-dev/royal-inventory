...
//################TANTELY#####################
    ...
    <h2 class="top20_style">TOP 20 DU MOIS</h2>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="#" method="post">
                                        ...
                                        $query_qt_details = "SELECT * FROM mvt INNER JOIN produit ON mvt.id_x = produit.id_x WHERE date_time > date_sub(now(), interval 5 week) AND type_de_mvt = 'vente' AND nom_client_fournisseur = ? AND mvt.id_x = ?;";
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="#" method="post">
                                        ...
                                        $query_mt_details = "SELECT *,(ABS(qt)*prix_unitaire) as Montant FROM mvt INNER JOIN produit ON mvt.id_x = produit.id_x WHERE date_time > date_sub(now(), interval 5 week) AND type_de_mvt = 'vente' AND nom_client_fournisseur = ? AND mvt.id_x = ?;";
